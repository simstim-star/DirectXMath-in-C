...
#define XM_VEC_SPLATX(V) XMVectorSplatX(XM_REF_1V(V))
XM_INLINE XMVECTOR XM_CALLCONV XMVectorSplatY(FXMVECTOR V);
#define XM_VEC_SPLATY(V) XMVectorSplatY(XM_REF_1V(V))
XM_INLINE XMVECTOR XM_CALLCONV XMVectorSplatZ(FXMVECTOR V);
#define XM_VEC_SPLATZ(V) XMVectorSplatZ(XM_REF_1V(V))
XM_INLINE XMVECTOR XM_CALLCONV XMVectorSplatW(FXMVECTOR V);
#define XM_VEC_SPLATW(V) XMVectorSplatW(XM_REF_1V(V))
...
inline XMMATRIX XM_CALLCONV XMMatrixLookAtLH(FXMVECTOR EyePosition, FXMVECTOR FocusPosition, FXMVECTOR UpDirection);
#define XM_MAT_LOOK_AT_LH(EYEPOS, EYEDIR, UPDIR) XMMatrixLookAtLH(XM_REF_3V(EYEPOS, EYEDIR, UPDIR))

inline XMMATRIX XM_CALLCONV XMMatrixLookAtRH(FXMVECTOR EyePosition, FXMVECTOR FocusPosition, FXMVECTOR UpDirection);
#define XM_MAT_LOOK_AT_RH(EYEPOS, EYEDIR, UPDIR) XMMatrixLookAtRH(XM_REF_3V(EYEPOS, EYEDIR, UPDIR))

XM_INLINE XMMATRIX XM_CALLCONV XMMatrixLookToLH(FXMVECTOR EyePosition, FXMVECTOR EyeDirection, FXMVECTOR UpDirection);
#define XM_MAT_LOOK_TO_LH(EYEPOS, EYEDIR, UPDIR) XMMatrixLookToLH(XM_REF_3V(EYEPOS, EYEDIR, UPDIR))

XM_INLINE XMMATRIX XM_CALLCONV XMMatrixLookToRH(FXMVECTOR EyePosition, FXMVECTOR EyeDirection, FXMVECTOR UpDirection);
#define XM_MAT_LOOK_TO_RH(EYEPOS, EYEDIR, UPDIR) XMMatrixLookToRH(XM_REF_3V(EYEPOS, EYEDIR, UPDIR))
